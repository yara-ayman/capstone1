...
docker tag web-app:1.0 564374043688.dkr.ecr.us-east-1.amazonaws.com/ecr:web-app-1.0

# Step 3:
# Push image to a docker repository
docker push 564374043688.dkr.ecr.us-east-1.amazonaws.com/ecr:web-app-1.0
